...
export const projects: Project[] = [
  ...
  {
    slug: "smart-expense-splitter",
    title: "Smart Expense Splitter",
    tagline: "A web app that splits shared expenses and settles balances fairly.",
    description:
      "A full-stack application for tracking shared expenses within groups and computing who owes whom.",
    problem:
      "Splitting group expenses manually is error-prone and hard to keep fair over time.",
    approach:
      "Built a full-stack app to record expenses, split them across group members, and compute minimal settlements.",
    impact:
      "Removes the friction and math from settling shared costs among friends or roommates.",
    role: "Designed and built the full-stack application.",
    stack: ["TypeScript", "React", "Next.js", "Node.js", "PostgreSQL"],
    featured: false,
    highlights: [
      "Group expense tracking and fair splitting",
      "Automated balance settlement",
    ],
    image: "/projects/smart-expense-splitter.jpg",
    links: {},
    year: "2024",
    domain: ["Software"],
  },
  {
    slug: "blockchain-legal-vault",
    title: "Blockchain Legal Vault",
    tagline:
      "Tamper-evident storage and verification for legal documents on-chain.",
    description:
      "A secure document vault that uses blockchain to guarantee the integrity and verifiability of legal documents.",
    problem:
      "Legal documents need tamper-proof storage and a trustworthy way to verify authenticity.",
    approach:
      "Built a web application that stores document proofs on-chain and lets users verify integrity against the original files.",
    impact:
      "Provides verifiable, tamper-evident custody of legal documents.",
    role: "Designed and built the application and verification flow.",
    stack: ["TypeScript", "React", "Next.js", "Node.js", "Solidity"],
    featured: false,
    highlights: [
      "On-chain document integrity proofs",
      "Verification of authenticity against originals",
    ],
    image: "/projects/blockchain-legal-vault.jpg",
    links: {},
    year: "2024",
    domain: ["Software"],
  },
